%% Problema 7.2 - Função de onda radial do átomo de hidrogénio
clc;
clear all;
close all;

% Para n =1. L tem que ser zero:
rmax=20;
n_esperado=1;
l=0;
E(1)=-0.6;
